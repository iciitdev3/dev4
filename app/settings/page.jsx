        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Manage your data, preferences, and account settings
            </p>
          </div>
          ...
          <Card className="border-0 shadow-lg mb-6">
            <CardHeader>
              ...
              <CardDescription>
                Customize your app experience and language settings
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Choose your preferred language for the app interface</p>
                </div>
                <LanguageToggle />
              </div>
            </CardContent>
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Backup, restore, or clear your personal data and progress
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DataManager />
